                        ...
                        <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header align-items-center d-flex">
                                        <h4 class="card-title mb-0 flex-grow-1">Audio</h4>
...
function getDatatable() {
    $('#phonesearchdata').on('click', function() {
        ...
        if (!phonenumber) {
            ...
            $.ajax({
                url: 'ajax/report/phonesearch.php?action=phonesearchlead',
                type: 'GET',
                data: {
...
function displayQCData(qcdata) {
    ...
    qcdata.forEach(function(value) {
        ...
        // var callcenter = value.agent_first_name ? value.agent_first_name.slice(0, 3) : ''; // Ensure agent exists
        ...
        $('.table_result_phonesearch').append(`
            <tr>
                ...
                <td>${value.leadid || ''}</td>
                <td>${value.campid || ''}</td>
                <td>${value.agent_first_name || ''}</td>
                <td>${value.full_name || ''}</td>
                <td>${phonenumber || ''}</td>
                <td>${value.status || ''}</td>
                <td>
                    <audio controls style="width: 105%;">
                        <source src="${value.audio_link_url || ''}" type="audio/mpeg">

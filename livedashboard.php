                                                    ...
                                                    <div class="row g-3 mb-0 align-items-center">
                                                        ...
                                                        <div class="col-sm-auto">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="date" id="startDate" value="<?php echo $today_date; ?>" class="form-control" hidden>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-auto">
                                                            <div class="form-group">
                                                                <!-- <label for="">End date</label> -->
                                                                <input type="date" id="endDate" value="<?php echo $today_date; ?>" class="form-control" hidden>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-auto">
                                                            <div class="form-group">
                                                                <select name="" id="campaign" class="form-select getRecord">
...
<script>
    $(document).ready(function () {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (data.status === 'Ok') {
                    ...
                    record.forEach((arr) => {
                        $('#campaign').append(`<option value="${arr.campaign}">${arr.display_name}</option>`);
                    });
                }
            }
        });
        ...
        // Function to process agent-wise stats
        function agentWise() {
            const record = overAllRecord.data;
            const total_agent = record.length;
            let total_calls = 0;
            let Hrs = 0, realHr = 0, pause_hr = 0, Transfer = 0, successtransfer = 0;
            ...
            const hr_with_min = Hrs.toFixed(2);
            const tph_percent = (successtransfer / hr_with_min).toFixed(2);
            const bph_percent = (Transfer / hr_with_min).toFixed(2);
            ...
            $('#bph_percent').attr('data-target', bph_percent).html(bph_percent);
            $('#total_billable').attr('data-target', Transfer).html(Transfer);
        }

        // Bind fetchReportData to manual trigger
        $('body').on('change', '.getRecord', fetchReportData);

...
function b() {
    ...
    const M = 10; // ✅ Show 3 items before "More"
    ...
    navItems.forEach((item, index) => {
        if (index + 1 <= M) {
            insertAfterItem = item; // Save the last visible item
        } else {
    ...
    // Add the "More" dropdown after the M-th item
    if (moreItemsHTML && insertAfterItem) {
        insertAfterItem.insertAdjacentHTML("afterend", `
            <li class="nav-item">

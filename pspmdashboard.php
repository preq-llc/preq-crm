...
<body>
                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-md-6">
                                        ...
                                        <div class="card card-animate">
                                            <div class="position-absolute start-0" style="z-index: 0;">
                                                                <svg version="1.2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 135" width="200" height="135">
                                                                    <style>
                                                                        .s0 {
                                                                            opacity: .05;
                                                                            fill: var(--vz-secondary)
    ...
    <!-- END layout-wrapper -->
        ...
        <div class="modal-dialog modal-dialog-centered modal-w75">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="username text-primary" style="cursor: pointer;"></h5>
    ...
    <script>
            ...
            function agentWise() {
                ...
                record.forEach(function(arr, idx) {
                    ...
                    <tr>
                        ...
                        <td>${arr.Transfer}</td>
                        <td>${arr.medds}</td>
                        <td>${(((parseFloat(arr.successtransfer) + parseFloat(arr.medds)) / (parseFloat(arr.Hrs) / 3600)).toFixed(2))}</td>
                ...
                overalltph = (parseFloat(tph_percent) + parseFloat(medds_percent)).toFixed(2);
        ...
        // });
            ...
            $('body').on('click','.username',function(){
                ...
                const campaign_name = $(this).data('campaign_id');
                const agent_id = $(this).data('agentid');


               window.location.href = `https://preqvoice.com/Preq-new/lead-report.php?fromdate=${startDate}&todate=${endDate}&campaign=${campaign_name}&agent=${agent_id}`;

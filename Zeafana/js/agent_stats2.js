...
overall_fetch_values(searchvalue,totalhours,totalcalsre,contactss);
...
function overall_fetch_values(searchvalue,totalhours,totalcalsre,contactss)
{
    $.ajax({
...
$(".contact_value").text("");
$(".contact_value").text(parseFloat((contactss/total_calls)*100).toFixed(2)+"%");

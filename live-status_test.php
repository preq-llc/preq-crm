...
<body>
                                    ...
                                    <div class="col-xl-12">
                                        <div class="card">
                                            <div class="card-header border-0 align-items-center d-flex">
                                                <h4 class="card-title mb-0 flex-grow-1">Live Status</h4>
                                                <div>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
        ...
        <div class="offcanvas-body">
            <div class="row usercanvasbody">
                <form id="bargeform" class="barge_form" action="#" method="GET">

                    <div class="col-12 pt-1">
                        <label for="">User</label>
                        <input type="text" class="form-control" name="user" value="PRAKASH45">
                        <input type="text" hidden class="form-control" name="source" value="test">
                    </div>
                    <div class="col-12 pt-3">
                        <label for="">Password</label>
                        <input type="password" class="form-control" name="pass" value="PRAKASH45">
                    ...
                    <div class="col-12 pt-3">
                        ...
                        <input type="text" class="form-control" id="barge_phone" name="phone_login" value="">
                    </div>
                    <div class="col-12 pt-3">
    ...
    <!-- Modal -->
    <div class="modal fade" id="phoneModal" tabindex="-1" aria-labelledby="phoneModalLabel" aria-hidden="true" style="margin-top: 300px;">
        <div class="modal-dialog">

            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="phoneModalLabel">Phone ID</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>

                <div class="modal-body">
                    <div id="phone-id-container">

                    </div>
                </div>

                <div class="modal-footer">
                    <input type="submit" id="barge_btntrigger_url" class="btn btn-primary" value="LISTEN">
                </div>
            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function autoreloadfunction(fromdatevalue, slctcampvalue, call_center, refreshCount) {
                ...
                $.ajax({
                    url: 'ajax/report/liveagent_test.php?action=all',
                    type: 'get',
                    data: {
                            ...
                            record.map(function(arr, idx) {
                                ...
                                $('.table_result').append(`
                                            <tr class="text-center">
                                                ...
                                                <td><button  data-username="${arr.user}" data-campip="${data.campip}" data-serverip="${arr.server_ip}" data-session_id="${arr.conf_exten}" class="barge_btn btn-soft-dark btn-sm"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-telephone-inbound" viewBox="0 0 16 16">
            ...
            $('body').on('click', '.barge_btn', function() {
                ...
                var source = $(this).data('source') || "test";
                ...
                $('#barge_btntrigger_url').data('campip', campip)
                    .data('session_id', session_id)
                    .data('server_ip', server_ip)
                    .data('source', source);

                handleBargeButtonClick(barge_phone_i, campip, session_id, server_ip, source);
            });

            function handleBargeButtonClick(barge_phone_i, campip, session_id, server_ip, source = "test") {
                if (!barge_phone_i) {

                    const phoneIdContainer = document.getElementById('phone-id-container');
                    phoneIdContainer.innerHTML = `
            <input type="text" id="barge_phone_input" name="barge_phone" class="form-control form-control-sm" placeholder="Enter phone ID" value="">
        `;
                    const myModal = new bootstrap.Modal(document.getElementById('phoneModal'));
                    myModal.show();
                } else {

                    $.ajax({
                        url: 'ajax/report/vicidial_proxy.php',
                        method: 'POST',
                        data: {
                            campip: campip,
            ...
            // Modal submit button
            $('body').on('click', '#barge_btntrigger_url', function(event) {
                event.preventDefault();

                var campip = $(this).data('campip');
                var session_id = $(this).data('session_id');
                var server_ip = $(this).data('server_ip');
                var source = $(this).data('source') || "test";
                var phone_login = $("#barge_phone_input").val();
                var pass = phone_login;

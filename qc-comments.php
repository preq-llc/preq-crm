...
<head>
    ...
    <meta charset="utf-8" />
    <title>QC Comments | Zealous - Dialer CRM</title>
    ...
    <script>
         $(document).ready(function(){
            ...
            $('body').on('click','#getRecord', function(){
                ...
                {
                    $.ajax({
                            url: 'ajax/qc/qc-comment.php?action=getQccommentsCount',
                            type: 'get',
                            data: {
                            ...
                            success: function(response)
                            {
                                ...
                                if(data.status == 'Ok')
                                {
                                    ...
                                    {
                                        $('.table_result').append('<tr><td>' + sno + '</td><td>' + key + '</td><td>' + value + '</td></tr>');
                                        sno++;
                                    });
                                        console.log(arr);

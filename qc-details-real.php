                                            ...
                                            <div class="mt-3 mt-lg-0">
                                                <form action="javascript:void(0);">
                                                    <div class="row g-3 mb-0 align-items-center">
                                                        ...
                                                        <div class="col-sm-auto">
                                                            <div class="form-group">
                                                                <label for="">QC Dispo</label>
                                                                <select name="" id="qc_dispo" class="form-select">
                                                        ...
                                                        <?php
                                                            if($logged_in_user_role == 'superadmin' || $logged_in_user_role == 'admin')
                                                            { 
                                                        ?>
                                                        <div class="col-sm-auto">
                                                            <div class="form-group">
                                                        ...
                                                        <?php
                                                            ...
                                                            {
                                                                echo `<input type="text" class="form-control" id="phone_number" hidden>`;
                                                            }
                                                        ?>
                                                        <div class="col-auto">
                                            ...
                                            <table id="export_table" class="table table-borderless table-centered align-middle table-nowrap mb-0">
                                                <thead class="text-muted table-light">
                                                    <tr>
                                                        ...
                                                        <th scope="col">Phone Number <span class="totalCallth"></span></th>
                                                        <th scope="col">Agent ID<span class="totalScoreth"></span></th>
                                                        <th scope="col">Campaigns <span class="totalQcth"></span></th>
                                                        <th scope="col">lead ID <span class="totalQcRejectth"></span></th>
                                                        <th scope="col">QC Dispo</th>
                                                        <th scope="col">QC Audited</th>
                                                        <th scope="col">Revert Dispo</th>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-12 py-3 qcDispoTable d-none">
                        ...
                        <table id="" class="table table-borderless table-centered align-middle mb-0">
                                <thead class="text-muted table-light">
                                <th class="col">ID</th>
    ...
    <script>
         $(document).ready(function(){
            ...
            $('body').on('click','#getRecord', function(){
                ...
                {
                    $.ajax({
                            url: 'ajax/qc/qc-details-real.php?action=getqcdetails',
                            type: 'get',
                            data: {
                            ...
                            success: function(response)
                            {
                                ...
                                if(data.status == 'Ok')
                                {
                                    ...
                                    record.map(function(arr, idx){
                                        ...
                                        var audio = new Audio(arr.audio_link_url);
                                        ...
                                        $('.table_result').append(`
                                            <tr>
                                                ...
                                                <td>${arr.camp}</td>
                                                <td>${arr.leadid}</td>
                                                <td><button class="btn `+qcDispoClr+` qcsubmitBtn" data-qccomment="${arr.QC_comments}" data-jsonrecord="${idx}">${arr.QC_dispo}</button></td>
            ...
            $('body').on('click', '.btn-soft-danger.qcsubmitBtn', function(){
                ...
                $.ajax({
                            url: 'ajax/qc/qc-details-real.php?action=getqcDispoDetails',
                            type: 'get',
                            data: {
            ...
            $('body').on('click', '.qcsubmitBtn', function(){
                ...
                else if(thisRecordData.camp == 'EDU_SB1')
                {
                    var modifiedUrl = thisRecordData.audio_link_url;

                    // var modifiedUrl = original_url.replace('rec203', 'rec203L');
                }
                else
                {
                    var modifiedUrl = thisRecordData.audio_link_url;

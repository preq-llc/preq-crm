                                    ...
                                    <div class="col-12">
                                        <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                                            <div class="flex-grow-1">
                                                ...
                                                <p class="text-muted mb-0">Get Current Billing on this Page.</p> 
                        ...
                        <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header align-items-center d-flex">
                                        <h4 class="card-title mb-0 flex-grow-1">Campaign Billing</h4>
                                            ...
                                            <table id="export_table" class="table table-borderless table-centered align-middle table-nowrap mb-0">
                                                <thead class="text-muted table-light">
                                                    <tr>
                                                        ...
                                                        <th scope="col">Successful transfers</th>
                                                        <th scope="col">Transfer connected</th>
                                                        <th scope="col">SPH</th>
                                                        <th scope="col">TPH</th>
